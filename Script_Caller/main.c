...
//! Holding needed information about the script.
typedef struct
{
    int       hour;
    int       minute;
    int       second;
    char      script_name[SCRIPT_NAME_MAX_LENGTH];
...
static tsScriptInfo fs_scripts_for_execution[] =
{
    // hour, minute, second, script_name,         pthread_id
    {  0,    0,    0,       "backup_monitor.py", &backupMonitor_pthread}
};

//! Count of the scripts.
static int fs_count_of_scripts_for_execution = (sizeof(fs_scripts_for_execution) / sizeof(tsScriptInfo));
